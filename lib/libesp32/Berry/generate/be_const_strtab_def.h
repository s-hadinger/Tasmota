...
be_define_const_str(cosh, "cosh", 4099687964u, 0, 4, &be_const_str_continue);
...
be_define_const_str(SYMBOL_TRASH, "SYMBOL_TRASH", 3169100368u, 0, 12, NULL);
be_define_const_str(REL1_INV, "REL1_INV", 3733155371u, 0, 8, &be_const_str_stop);
...
be_define_const_str(AudioOutputI2S, "AudioOutputI2S", 638031784u, 0, 14, &be_const_str__read);
...
be_define_const_str(DDSU666_TX, "DDSU666_TX", 1880604150u, 0, 10, &be_const_str_except);
...
be_define_const_str(HPMA_RX, "HPMA_RX", 3462528998u, 0, 7, &be_const_str_INTERRUPT);
be_define_const_str(INTERRUPT, "INTERRUPT", 3809502704u, 0, 9, &be_const_str_SM16716_DAT);
...
be_define_const_str(compile, "compile", 1000265118u, 0, 7, &be_const_str_publish_result);
...
be_define_const_str(KEY1_PD, "KEY1_PD", 3934075620u, 0, 7, &be_const_str_lv_list);
...
be_define_const_str(_available, "_available", 1306196581u, 0, 10, &be_const_str_sin);
be_define_const_str(sin, "sin", 3761252941u, 0, 3, NULL);
be_define_const_str(I2S_IN_CLK, "I2S_IN_CLK", 2996930120u, 0, 10, &be_const_str_SM2135_DAT);
...
be_define_const_str(map, "map", 3751997361u, 0, 3, &be_const_str_toint);
...
be_define_const_str(asin, "asin", 4272848550u, 0, 4, &be_const_str_state);
...
be_define_const_str(log10, "log10", 2346846000u, 0, 5, &be_const_str_members);
...
be_define_const_str(I2S_OUT_DATA, "I2S_OUT_DATA", 1176288293u, 0, 12, &be_const_str_SBR_TX);
...
be_define_const_str(ELECTRIQ_MOODL_TX, "ELECTRIQ_MOODL_TX", 31009247u, 0, 17, &be_const_str_I2S_OUT_CLK);
be_define_const_str(I2S_OUT_CLK, "I2S_OUT_CLK", 2580200387u, 0, 11, &be_const_str_SYMBOL_BATTERY_1);
...
be_define_const_str(arg_size, "arg_size", 3310243257u, 0, 8, &be_const_str_loop);
...
be_define_const_str(AudioFileSource, "AudioFileSource", 2959980058u, 0, 15, &be_const_str_has_arg);
...
be_define_const_str(AudioFileSourceFS, "AudioFileSourceFS", 1839147653u, 0, 17, &be_const_str_SSPI_MOSI);
...
be_define_const_str(EPAPER29_CS, "EPAPER29_CS", 3916373594u, 0, 11, &be_const_str_isrunning);
be_define_const_str(isrunning, "isrunning", 1688182268u, 0, 9, &be_const_str_lv_chart);
...
be_define_const_str(DDS2382_TX, "DDS2382_TX", 1438117864u, 0, 10, &be_const_str_KEY1_INV_PD);
be_define_const_str(KEY1_INV_PD, "KEY1_INV_PD", 3828014584u, 0, 11, &be_const_str_ROT1B_NP);
...
be_define_const_str(P9813_CLK, "P9813_CLK", 2455391001u, 0, 9, &be_const_str_close);
be_define_const_str(close, "close", 667630371u, 0, 5, &be_const_str_lv_area);
...
be_define_const_str(I2S_OUT_SLCT, "I2S_OUT_SLCT", 4037293837u, 0, 12, &be_const_str_content_stop);
...
be_define_const_str(HRXL_RX, "HRXL_RX", 92702006u, 0, 7, &be_const_str_lv_arc);
...
be_define_const_str(eth, "eth", 2191266556u, 0, 3, &be_const_str_isinstance);
...
be_define_const_str(I2S_IN_DATA, "I2S_IN_DATA", 4125971460u, 0, 11, &be_const_str_cos);
