...
static be_define_const_map_slots(be_class_tasmota_driver_map) {
    { be_const_key(save_before_restart, -1), be_const_int(0) },
    { be_const_key(add_cmd, -1), be_const_closure(add_cmd_closure) },
    { be_const_key(display, -1), be_const_int(1) },
    { be_const_key(web_add_button, 12), be_const_int(2) },
    { be_const_key(json_append, -1), be_const_int(3) },
    { be_const_key(web_add_main_button, 11), be_const_int(4) },
    { be_const_key(web_sensor, 5), be_const_int(5) },
    { be_const_key(web_add_handler, -1), be_const_int(6) },
    { be_const_key(button_pressed, -1), be_const_int(7) },
    { be_const_key(every_second, 1), be_const_int(8) },
    { be_const_key(web_root, -1), be_const_int(9) },
    { be_const_key(every_100ms, -1), be_const_int(10) },
