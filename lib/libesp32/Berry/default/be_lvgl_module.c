...
const lvbe_call_c_t lv_func[] = {
  ...
  { "event_get_code", (void*) &lv_event_get_code, "i", "(lv_event)" },
  { "event_get_current_target", (void*) &lv_event_get_current_target, "lv_obj", "(lv_event)" },
  { "event_get_key", (void*) &lv_event_get_key, "i", "(lv_event)" },
  { "event_get_param", (void*) &lv_event_get_param, ".", "(lv_event)" },
  { "event_get_target", (void*) &lv_event_get_target, "lv_obj", "(lv_event)" },
  { "event_get_user_data", (void*) &lv_event_get_user_data, ".", "(lv_event)" },
