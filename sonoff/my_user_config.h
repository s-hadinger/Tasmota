...
// -- Location ------------------------------------
#define LATITUDE               48.8039           // [Latitude] Your location to be used with sunrise and sunset
#define LONGITUDE              2.0842            // [Longitude] Your location to be used with sunrise and sunset
...
//#define USE_MQTT_TLS                             // Use TLS for MQTT connection (+34.5k code, +7.0k mem and +6.7k additional during connection handshake)
//  #define USE_MQTT_TLS_CA_CERT                   // Force full CA validation instead of fingerprints, slower, but simpler to use (+2.3k code, +2.3k mem during connection handshake)
//  #define USE_MQTT_AWS_IOT                       // Enable MQTT for AWS IoT - requires a private key (+11.5k code, +0.4k mem)
