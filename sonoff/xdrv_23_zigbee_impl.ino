...
ZBM(ZBR_PAN, SRSP | SAPI, READ_CONFIGURATION, Z_Success, PANID, 0x02 /* len */,
...
// Write PAN ID
ZBM(ZBS_W_PAN, SREQ | SAPI, WRITE_CONFIGURATION, PANID, 0x02 /* len */, Z_B0(USE_ZIGBEE_PANID), Z_B1(USE_ZIGBEE_PANID)  )				// 26058302xxxx
// Write EXT PAN ID
ZBM(ZBS_W_EXTPAN, SREQ | SAPI, WRITE_CONFIGURATION, EXTENDED_PAN_ID, 0x08 /* len */,
                  Z_B0(USE_ZIGBEE_EXTPANID), Z_B1(USE_ZIGBEE_EXTPANID), Z_B2(USE_ZIGBEE_EXTPANID), Z_B3(USE_ZIGBEE_EXTPANID),
                  Z_B4(USE_ZIGBEE_EXTPANID), Z_B5(USE_ZIGBEE_EXTPANID), Z_B6(USE_ZIGBEE_EXTPANID), Z_B7(USE_ZIGBEE_EXTPANID)
                  ) // 26052D086263151D004B1200
// Write Channel ID
ZBM(ZBS_W_CHANN, SREQ | SAPI, WRITE_CONFIGURATION, CHANLIST, 0x04 /* len */,
                Z_B0(USE_ZIGBEE_CHANNEL), Z_B1(USE_ZIGBEE_CHANNEL), Z_B2(USE_ZIGBEE_CHANNEL), Z_B3(USE_ZIGBEE_CHANNEL),
...
// Write Security Mode
ZBM(ZBS_WNV_SECMODE, SREQ | SYS, SYS_OSAL_NV_WRITE, Z_B0(TCLK_TABLE_START), Z_B1(TCLK_TABLE_START),
