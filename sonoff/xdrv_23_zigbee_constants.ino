...
enum ZdoStates {
  ...
  DEV_NWK_DISC = 0x02,          // Discovering PANIDs to join
  DEV_NWK_JOINING = 0x03,       // Joining a PAN
  DEV_NWK_REJOIN = 0x04,        // ReJoining a PAN, only for end devices
  DEV_END_DEVICE_UNAUTH = 0x05, // Joined but not yet authenticated by trust center
  DEV_END_DEVICE = 0x06,        // Started as a device after authentication. Note: you'll see this for both Routers or End Devices.
  DEV_ROUTER = 0x07,            // Started as a Zigbee Router
  DEV_COORD_STARTING = 0x08,    // Starting as a Zigbee Coordinator
  DEV_ZB_COORD = 0x09,          // Started as a a Zigbee Coordinator
